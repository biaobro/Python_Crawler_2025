...
"""
@File               : main.py
@Project            : S025_MaShangPa_005
@CreateTime         : 2025/10/18 11:56
@Author             : biaobro
@Software           : PyCharm
@Last Modify Time   : 2025/10/18 11:56 
@Version            : 1.0
@Description        : None
"""
import requests
...
for page in range(1, 21):
    xl = execjs.compile(open('pagination.js', encoding='utf-8').read()).call('loadPage', page)
    json_data = {
        'xl': xl,
    }
