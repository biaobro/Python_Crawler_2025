...
function md5(e) {
    ...
    // 确保补环境得到的值和网站得到的值相同，会发现他和  是一样的问题
    // console.log(t(3))
    r[t(3)] = function (e, t) {
        return e(t)
    }
...
function btoa(e) {
    ...
    // 这里实际会遇到1个问题，如果在网页代码中往上找 u，进而找到 _0x34e7，如果直接复制粘贴 _0x34e7 的值，是有问题的
    // _0x34e7 的值在运行到这里前发生了变化
    // 所以需要在这里打上断点，得到 _0x34e7 的值，按最新的值赋值
    // console.log(t(244))
