var _$Tk = CryptoJS = require('crypto-js');
var _0x4e96b4 = window = global
    ,_0x30bc70 = String
    ,_0x35bb1d = Date
...
// _0x4e96b4['_$6_'] ; _0x4e96b4['_$tT'];  _0x4e96b4['_$Jy'] 3个变量在初始运行和后续运行时的值不同，所以需要赋初始值
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    console.log('Enter :', _0x4e96b4['_$6_'], _0x4e96b4['_$Jy'], _0x4e96b4['_$tT'])
    _0x193f00[_0x1cfe89 >> 0x5] |= 0x80 << _0x1cfe89 % 0x20,
    _0x193f00[0xe + (_0x1cfe89 + 0x40 >>> 0x9 << 0x4)] = _0x1cfe89;
    // try {
    //     // XMLHttpRequest.readyState['DONE'] 一直是4，可以把这里的 try catch 省略掉
    //     var _0x42fb36 = _0x4e96b4['XMLHttpRequest']['prototype']['DONE'] * 0x4;
    // } catch (_0x1b1b35) {
    //     var _0x42fb36 = 0x1;
    // }
    var _0x42fb36 = 4 * 0x4;
    try {
        // _0x4e96b4 window 实际都没有这个 $_z2，所以一定会跑到 catch
        _0x4e96b4['$_z2'][0x0] = 'Q';
    } catch (_0x4c574d) {
        // try {
        //     // 根据前面抠出来的代码，数据长度固定是27
        //     // 可以直接写成 op = 27
    ...
    console.log('Exit :', _0x4e96b4['_$6_'], _0x4e96b4['_$Jy'], _0x4e96b4['_$tT'])
...
function _0x474032(_0x233f82, _0xe2ed33, _0x3229f9) {
    ...
    //     // 因为 _0xe2ed33 是 undefined 所以会执行 下面这部分
    //     : _0x3229f9
    //         ? _0x41873d(_0x233f82)
    //         // 因为 _0x3229f9 是 undefined 所以会执行下面这部分
    //         : _0x37614a(_0x233f82);
...
function encrypt(){
    // _0x4e96b4['_$6_'] ; _0x4e96b4['_$tT'];  _0x4e96b4['_$Jy']
    _0x4e96b4 = {
        _$6_ : undefined,
        _$tT: undefined, //-0xa40bd9c,
        _$Jy: undefined, //0x1b821d58,
        _$pr: [],
    }

    // 开始的4次 m 赋值，看起来并不关心
    // _0x4e96b4['_$6_'] , _0x4e96b4['_$Jy'] , _0x4e96b4['_$tT'] 这3个变量的值
    for (let i = 0; i < 4; i ++){
        // m 赋值 执行4次
        _$Wa = _0x12eaf3();
        m = _0x474032(_$Wa);
    ...
    // RM4 赋值3次 都是 undefined 忽略掉

    // m 赋值1次，与之前的代码不同
    // 需要特别注意的是这3个值，在第5次执行m赋值中的 _0x11a7a2 函数时发生了变化
    ...
    // nodejs 用 btoa 直接替换 _0x4e96b4['btoa']
    // _0x4e96b4['_$qF']  实际是加密算法中的 key
    ...
    let data = {
        cookies_m: m,
        cookies_RM4: RM4hZBv0dDon443M,
        params_m: _0x4e96b4['_$is'],
        params_f: Date.parse(new Date()),
    };
    return data;
}
